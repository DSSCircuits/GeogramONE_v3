...
SIMCOM::SIMCOM(AltSoftSerial *ser)
{
	GSM = ser;
}

void SIMCOM::initializeGSM()
{
	...
	if(!powerOK)
	{
		...
		GSM->print("AT+IPR=");
		GSM->println(/*BAUD_RATE*/9600,DEC);
...
**************************************************************/
/*uint8_t*/bool SIMCOM::gsmSleepMode(int mode)
{
	GSM->println("AT\r\nAT");
	delay(50);
	GSM->print("AT+CSCLK=");
...
**************************************************************/
/*uint8_t*/bool SIMCOM::confirmAtCommand(char *searchString, unsigned long timeOut)
{
	uint8_t index = 0;
...
**************************************************************/
/*uint8_t*/bool SIMCOM::powerDownGSM()
{
...
**************************************************************/
bool SIMCOM::checkNetworkRegistration()
{
	GSM->println("AT+CREG?");
...
**************************************************************/
uint8_t SIMCOM::checkForMessages()
{
	GSM->println("AT+CPMS?");
...
RETURN:
	...
	3				Timeout reached, potential problem
**************************************************************/
/*uint8_t*/bool SIMCOM::deleteMessage(int msg)
{
	GSM->print("AT+CMGD=");
	GSM->println(msg);
...
RETURN:
	...
	3				Timeout reached, potential problem
**************************************************************/
/*uint8_t*/bool SIMCOM::deleteAllMessages()
{
...
**************************************************************/
bool SIMCOM::prepareSMS(char *smsAddress /*, uint32_t apn*/)
{
//	bool isEmail = false;
...
uint8_t SIMCOM::readMessageBreakOut(int msg)
{
	GSM->print("AT+CMGR=");
	GSM->println(msg);
